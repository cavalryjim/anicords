...
class HouseholdsControllerTest < ActionController::TestCase
  ...
  test "should create household" do
    assert_difference('Household.count') do
      post :create, household: { address1: @household.address1, address2: @household.address2, name: @household.name, phone: @household.phone }
    end
  ...
  test "should update household" do
    patch :update, id: @household, household: { address1: @household.address1, address2: @household.address2, name: @household.name, phone: @household.phone }
    assert_redirected_to household_path(assigns(:household))
  end
