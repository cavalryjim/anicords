...
(function() {
  jQuery(function() {
    ...
    return $('#service_provider').autocomplete({
...
(function() {
  jQuery(function() {
    $(".service_provider_type").change(function() {
      ...
      if (this.checked) {
        parent = this.value;
        return $.get("/services?spt[]=" + parent, function(data) {
          return $.each(data, function(key, value) {
            return $("#available_services").append($("<li class='child_of_" + parent + "'><label for='service_" + value.id + "'><input id='service_" + value.id + "' name='service_provider[service_ids][]' type='checkbox' value=" + value.id + " /> <span class='custom checkbox'></span>" + value.text + "</label></li>"));
          });
        });
      } else {
    ...
    return $(".veterinarian").change(function() {
      if (this.checked) {
        return $("#veterinarian_list").removeClass("hidden");
      } else {
        return $("#veterinarian_list").addClass("hidden");
      }
    });
  });
